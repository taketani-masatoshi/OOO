const copy = {
  en: {
    ...
    step3Lead:
      "Start on the executive home — check today’s counts, then open Secretary and Inter-org from there.",
    urlHomeLabel: "Home",
    urlSecretaryLabel: "Secretary",
  ...
  ja: {
    ...
    step3Lead:
      "まず経営ホームで今日の件数を見てから、秘書と相手組織へ進みます。",
    urlHomeLabel: "経営ホーム",
    urlSecretaryLabel: "秘書",
    urlWireLabel: "相手組織",
  ...
  zh: {
    ...
    step3Title: "3. 在浏览器打开",
    step3Lead: "先从经营首页查看今日计数，再进入秘书与对方组织。",
    urlHomeLabel: "首页",
    urlSecretaryLabel: "秘书",
    urlWireLabel: "对方组织",
