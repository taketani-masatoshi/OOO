...
raise SystemExit(subprocess.call(['node','node_modules/vitest/vitest.mjs','run','--config','vitest.annual-observations.config.ts','--reporter=default','--reporter=json','--outputFile.json=annual-observation-results.json'],cwd=root,env=env))
