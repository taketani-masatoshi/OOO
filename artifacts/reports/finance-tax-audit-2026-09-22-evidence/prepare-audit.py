...
''')
selected=['annual-close','annual-close-acceptance','monthly-close-acceptance','consumption-tax-journal','tax-adjustment-acceptance','ledger-trial-balance','finance-statements','bank-reconciliation-gl','period-lock-invoice-dedupe','jp-bank-corporate-reconciliation','external-reconciliation','tax-remittance-integrity','ledger-journal-export','tax-engines','tax-readiness','indirect-tax-port','jp-corporate-tax-xml','tax-filing-prep','cash-flow-statement','journal-tax-backfill','payroll-jp','payroll-yea-compute','payroll-remittance-loop','sole-prop-lane-f']
...
''')
Path('/private/tmp/ooo-finance-audit-current').write_text(str(root))
print(root)
