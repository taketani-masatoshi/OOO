...
raise SystemExit(subprocess.call(['node','node_modules/vitest/vitest.mjs','run','--config','vitest.observations.config.ts','--reporter=default','--reporter=json','--outputFile.json=observation-results.json'],cwd=root,env=env))
